...
Add-??? -DnsName Test-DC1.herdt.ps -IPAddress 192.168.200.10
# Get-DhcpServerInDC
#Configure scope herdt
Add-Dhcp???? -name "herdt" -StartRange 192.168.200.100 -EndRange 192.168.200.150 -SubnetMask 255.255.255.0 -State Active 
#GW
